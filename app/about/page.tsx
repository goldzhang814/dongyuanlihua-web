...
export const metadata: Metadata = {
  title: "About Doniva",
  description: "Doniva International Development Co., Ltd. — a licensed import-export enterprise and the authorized Bangladesh market agent for KCLKA shoe machinery and Xinyang Special Fiber acetate tow.",
  keywords: ["Shenzhen import export company", "China industrial sourcing company", ...targetKeywords],
  alternates: { canonical: "/about-us" },
};

export default function AboutPage() {
  return <><SiteHeader /><PageIntro eyebrow="ABOUT US / 04" title={<>A direct line to <em>better supply.</em></>} copy="Doniva is a Shenzhen-based international trading company focused on authorized Chinese industrial equipment and materials for South Asian manufacturers." /><main className="about-page">
