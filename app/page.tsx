...
export const metadata: Metadata = {
  ...
  description: "Dongyuan Lihua is a Shenzhen import export company and authorized Bangladesh partner for KCLKA shoe machinery and Xinyang diacetate fiber tow.",
  keywords: targetKeywords,
  alternates: { canonical: "/" },
};

const productCards = [
  { number: "01", eyebrow: "KCLKA OFFICIAL AGENT", title: "Footwear Machinery", copy: "Complete EVA, PVC, TPR and PU production systems for modern shoe factories and export lines.", tone: "machinery", href: "/products?category=shoe-machinery" },
  { number: "02", eyebrow: "JIAPINYUN PARTNERSHIP", title: "Material Supply", copy: "Industrial components, fittings and sourced materials from China’s footwear manufacturing hubs.", tone: "materials", href: "/products?category=shoe-materials" },
  { number: "03", eyebrow: "XINYANG EXPORT AGENT", title: "Acetate Tow", copy: "Diacetate fiber tow for cigarette filters, hygiene products and high-precision filtration uses.", tone: "tow", href: "/products?category=acetate-tow" },
];
